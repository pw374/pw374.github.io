...
# 0 "tags/raspberrypi/index.md.ml"
 let _ = print_string ""
 module Meta : Meta = struct
 let title = "blog#raspberrypi"
 ...
 let tags = [ "raspberrypi"; ]
end
include Meta
 let _ = print_string "\n"
 module Post(Unit:Unit) = struct  let _ = print_string "# "
 let _ = !!title  let _ = print_string "\n\n"
 let _ = cat "tags/raspberrypi/index.contents.md"  let _ = print_string "\n"
 ...
 let _ = if not (List.mem "root" tags || List.mem "projects" tags) then print_string "class='active'"  let _ = print_string "><a href=\"/blog.html\">blog</a></li>\n              <li "
